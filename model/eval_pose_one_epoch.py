...
class Trainer_pose(object):
    ...
    def process_data_dict(self, data):
        ...
        return (img, depth_img, camera_mat, scale_mat, img_idx, mask_img)
    ...
    def compute_loss(self, data, eval_mode=False, it=100000):
        ...
        (img, depth_img, camera_mat, scale_mat, img_idx, mask_img) = self.process_data_dict(data)
        # Shortcuts
        device = self.device
        batch_size, _, h, w = img.shape
